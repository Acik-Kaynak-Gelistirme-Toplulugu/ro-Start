  ...
  return (
    <div className="space-y-4 h-full flex flex-col">
      <div className="text-center space-y-2 flex-shrink-0">
        ...
        <h1 className={`${themeConfig.textHeading} text-4xl font-bold`}>
          ...
          {popularApps.map((app, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-4 h-full">
                <div
                  className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-white/40 to-white/10 backdrop-blur-xl border ${themeConfig.borderColor} flex items-center justify-center shadow-sm`}
                >
                  {React.createElement(app.icon, {
                    className: `w-7 h-7 ${themeConfig.iconPrimary}`,
                  })}
                </div>
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between h-full py-1">
                  <div>
                    <h3
                      className={`${themeConfig.textHeading} mb-1 truncate font-semibold text-lg`}
                    >
                      {app.name}
                    </h3>
